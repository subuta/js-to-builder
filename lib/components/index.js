...
export const JSXOpeningElement = ({children}) => {
  return b.jsxOpeningElement.apply(this, children)
}
...
export const JSXClosingElement = ({children}) => {
  return b.jsxClosingElement.apply(this, children)
}
