...
// AST(JSX) to builder
export const Program = ({children: body}) => {
  return b.program.apply(this, [body])
}

export const ReturnStatement = ({children: argument}) => {
  return b.returnStatement.apply(this, argument)
}
...
export const VariableDeclarator = ({children: [id, init]}) => {
  return b.variableDeclarator.apply(this, [id, init])
}
...
export const BlockStatement = ({props, children: body}) => {
  return b.blockStatement.apply(this, [body])
}
