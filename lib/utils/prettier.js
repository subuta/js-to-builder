// browser compatible prettier.
// https://github.com/prettier/prettier/blob/master/index.js

const comments = require('prettier/src/comments')
const printAstToDoc = require('prettier/src/printer').printAstToDoc
const printDocToString = require('prettier/src/doc-printer').printDocToString
const util = require('prettier/src/util')
const parser = require('prettier/src/parser')
